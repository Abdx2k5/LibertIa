...
const MarkerPinIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <path d="M12 22s7-6.5 7-12a7 7 0 1 0-14 0c0 5.5 7 12 7 12Z" fill="var(--accent)" stroke="var(--bg)" strokeWidth="1.5" />
    <circle cx="12" cy="10" r="2.5" fill="var(--bg)" />
  </svg>
);
  ...
  useEffect(() => {
    ...
    const placerMarqueurs = () => {
      ...
      valides.forEach((p) => {
        ...
        el.innerHTML = `<svg width="28" height="28" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 22s7-6.5 7-12a7 7 0 1 0-14 0c0 5.5 7 12 7 12Z" fill="var(--accent)" stroke="var(--bg)" stroke-width="1.5"/><circle cx="12" cy="10" r="2.5" fill="var(--bg)"/></svg>`;
