...
const IconMsg      = () => <svg {...sv}><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>;
const IconPartners = () => <svg {...sv}><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><polyline points="17 11 19 13 23 9"/></svg>;
...
const NAV = [
  ...
  { label:"Messages",    to:"/messages",    icon:IconMsg },
  { label:"Partenaires", to:"/partners",    icon:IconPartners },
