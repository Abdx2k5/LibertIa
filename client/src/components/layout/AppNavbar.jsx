...
const IconEye          = (p) => <svg {...menuSvgProps} {...p}><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>;
      ...
      <nav className={styles.navbar}>
        ...
        <div className={styles.navRight}>
          ...
          <div className={styles.avatarMenuWrap} ref={avatarMenuRef}>
            ...
            >
              <img src={user?.profilePhoto && user.profilePhoto !== "default-avatar.png" ? user.profilePhoto : imgAvatar} alt={user?.nom || "Profil"} className={styles.navAvatarImg} />
            </button>
            ...
            {avatarMenuOpen && (
              <div className={styles.avatarMenu} role="menu">
                ...
                <button
                  ...
                  onClick={() => { setAvatarMenuOpen(false); navigate(publicProfilePath(user?._id || user?.id)); }}
                >
                  <IconEye /> Voir mon profil public
                </button>
